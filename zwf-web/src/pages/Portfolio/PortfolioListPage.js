  ...
  return (
    <LayoutStyled>
      ...
      <ContainerStyled>
        ...
        <Paragraph>Client register as user in our platform to authorise ZeeWorkFlow to be the accountant and tax agent to deal with all the task set up in each portfolio which is under the user’s name. The task can be set up either by client itself or ZeeWorkFlow according to engagement letter.</Paragraph>
