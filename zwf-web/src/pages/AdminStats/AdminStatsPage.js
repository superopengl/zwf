  ...
  return (
    <LayoutStyled>
      ...
      <ContainerStyled>
        ...
        <Row gutter={40}>
          <Col {...span}>
            <StatCard title={<Link to="/user">User <MdOpenInNew /></Link>} value={stats?.user} loading={loading} color={['#b37feb', '#91d5ff', '#0FBFC4']} />
          </Col>
          <Col {...span}>
            <StatCard title="Portfolio" value={stats?.portfolio} loading={loading} />
          </Col>
          <Col {...span} >
            <StatCard title={<Link to="/tasks">Task <MdOpenInNew /></Link>} value={stats?.task} loading={loading} color={['#91d5ff', '#ff7875', '#0FBFC4', '#87e8de', '#b37feb']}/>
          </Col>
        </Row>
      </ContainerStyled>
    </LayoutStyled >
