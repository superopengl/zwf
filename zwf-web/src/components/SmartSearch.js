...
import Tag from './Tag';
import { smartSearchTask$, smartSearchFemplate$, smartSearchDemplate$, smartSearchClient$ } from 'services/smartSearchService';
...
const DOMAIN_CONFIG = {
  ...
  'demplate': {
    ...
    noFoundContent: <><DemplateIcon /> No doc template is found.</>
  },
  'client': {
