...
const DeclarationPage = () => (
  <ContainerStyled>
    ...
    <p>For the document where it is to be lodged to the ATO electronically. I, the business owner, authorise J.Z. Accounting trading as Filedin to give the e-signed document to the commissioner of Taxation. The agent is authorised to lodge this form.</p>
