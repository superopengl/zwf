...
const PrivacyPolicyPage = () => (
  <ContainerStyled>
    ...
    <Title style={{ textAlign: 'center' }}>AU Accounting Office Pty Ltd - Privacy Policy</Title>
    <p>Protecting your privacy and the confidentiality of your personal information is a high priority for AU Accounting Office Pty Ltd.</p>
    <p>Personal information with regards to this website and all AU Accounting Office Pty Ltd online portals (and any other AU Accounting Office Pty Ltd printed materials) means information we hold about you from which we can search for and retrieve your identity. For example, we may collect and use your name and address details when you acquire or use particular AU Accounting Office Pty Ltd membership services. AU Accounting Office Pty Ltd understands that providing your personal information imposes a serious responsibility upon us.</p>
    ...
    <p>We collect personal information directly from you, and only to the extent necessary to deliver and ensure a AU Accounting Office Pty Ltd membership service. We may choose to collect personal information from you when you fill in an application form, both in hard copy format or online via our website, or over the telephone.</p>
    ...
    <p>If we do not collect this information, we may not be able to provide you with the AU Accounting Office Pty Ltd membership service you have requested.</p>
    ...
    <p>AU Accounting Office Pty Ltd will collect your personal information in order to provide you with, or give you access to, a particular AU Accounting Office Pty Ltd membership service. AU Accounting Office Pty Ltd may choose to disclose your personal information for the main purpose for which we collect it, with such disclosure reasonably expected by you. Some of these examples include, but are not limited to:</p>
    <ul>
      <li>Helping AU Accounting Office Pty Ltd to develop a stronger relationship with you</li>
      <li>Internal membership management, accounting and finance</li>
      <li>Administrative reporting</li>
      <li>Protecting you and AU Accounting Office Pty Ltd from fraud</li>
      <li>As part of a AU Accounting Office Pty Ltd campaign.</li>
    </ul>
...
marketing information from AU Accounting Office Pty Ltd, please let us know.</p>
    <Divider/>
    ...
    AU Accounting Office Pty Ltd will take reasonable steps to ensure the personal information we collect, use and disclose is
...
incomplete or out-of-date, please contact us immediately and we will take reasonable steps to correct it.</p>
    <Divider/>
    <Title level={2} id="fln-allied-pty-ltd-campaigns">AU Accounting Office Pty Ltd Campaigns</Title>
    <p>AU Accounting Office Pty Ltd conducts various campaigns and from time to time may use your contact details to update
    you on the status of a campaign. Likewise, AU Accounting Office Pty Ltd may also use your details for specific petitions
    on campaigns. If you have signed a petition, your details may be used for instances such as presenting this
    information to members of Parliament. If you do not wish for AU Accounting Office Pty Ltd to contact you via phone or
email during or campaign or present a petition you have signed, please let us know.</p>
    ...
    <p>AU Accounting Office Pty Ltd takes reasonable steps to protect your personal information from loss, misuse, unauthorised
disclosure or destruction.</p>
    <Divider/>
    <Title level={2} id="cookies-on-fln-allied-pty-ltd-website">Cookies on AU Accounting Office Pty Ltd website</Title>
    <p>A "cookie" is a packet of information that allows the AU Accounting Office Pty Ltd server (the computer that houses our
...
sent. Please refer to your Internet browser's instructions or help screens to learn more about these functions.</p>
    <Divider/>
    <Title level={2} id="information-logged-on-the-fln-allied-pty-ltd-website">Information logged on the AU Accounting Office Pty Ltd website</Title>
    <p>When you visit the AU Accounting Office Pty Ltd web site, our server logs the following information which is provided by your browser for statistical purposes only:</p>
    <ul>
    ...
    <p>AU Accounting Office Pty Ltd will, upon your request, and subject to applicable privacy laws, provide you with access to your personal information held by us. However, we ask that you identify, as clearly as possible, the type/s of information requested.</p>
    <Divider/>
    <Title level={2} id="contact-the-fln-allied-pty-ltd-privacy-officer">Contact the AU Accounting Office Pty Ltd Privacy Officer</Title>
    <p>Please email your query and contact details (your name, contact phone number and email address) to the AU Accounting Office Pty Ltd Officer at <a href="mailto:office.fln.allied@gmail.com">office.fln.allied@gmail.com</a>. We will respond to your query or complaint within 14 working days from the date first lodged. If your complaint is not resolved to your satisfaction you can contact the Office of the Privacy Commissioner on <a href="tel:1300 363 992">1300 363 992</a>.</p>
